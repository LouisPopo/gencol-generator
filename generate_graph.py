...
for n in ['4', '5', '6']:
    for i in ['0', '1', '2']:
        instance_name = "4b_{}_{}".format(n, i)
        ...
        dual_vars = pd.read_csv(network_folder + "/dualVarsFirstLinearRelaxProblem{}_default.out".format(instance_name), sep=' ', names=['name', 'pi_value'])
        ...
        df_nodes.to_csv('Networks/Network{}/graph_nodes.csv'.format(instance_name), sep=';')
        df_edges.to_csv('Networks/Network{}/graph_edges.csv'.format(instance_name), sep=';')
