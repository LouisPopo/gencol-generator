...
create_gencol_file([problem], nb_veh=int(args.nb_veh), dual_variables_file_name=dual_variables_file_name, nb_inequalities=int(args.nb_ineq), grp_size=0, random_ineq=True)
