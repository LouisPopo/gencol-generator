    ...
    for instance in glob.glob('Networks/{}/*/'.format(experience_name)):
        ...
        for percent_ineq in [0.05, 0.1, 0.25, 0.5]:
            for percent_wrong in [0, 0.1, 0.25, 0.5, 0.75]:
                create_gencol_file([instance_name], path_to_networks=path_to_networks,nb_veh=nb_veh, dual_variables_file_name=dual_variables_file_name, take_absolute_value=False, percentage_ineq=percent_ineq, random_ineq=False, percentage_wrong=percent_wrong, nb_grps=1)
    ...
    for instance in glob.glob('Networks/{}/*/'.format(experience_name)):
        ...
        for percent_ineq in [0.05, 0.1, 0.25, 0.5]:
            for nb_grps in [2, 5, 10, 20]:
                create_gencol_file([instance_name], path_to_networks=path_to_networks,nb_veh=nb_veh, dual_variables_file_name=dual_variables_file_name, take_absolute_value=False, percentage_ineq=percent_ineq, random_ineq=False, nb_grps=nb_grps)
